...
import static com.crossoverjie.cim.route.constant.ConstantRedis.ACCOUNT_PREFIX;
import static com.crossoverjie.cim.route.constant.ConstantRedis.LOGIN_STATUS_PREFIX;
...
public class UserInfoCacheServiceImpl implements UserInfoCacheService {
    ...
    public CIMUserInfo loadUserInfoByUserId(Long userId) {
        ...
        log.error("userId:{}----username:{}", userId, sendUserName);
